...
{
    class PQReferenceStatusMap : EntityTypeConfiguration<PQReferenceStatus>
    {
        public PQReferenceStatusMap()
        {
            this.HasKey(a => a.ReferenceStatusRowID);
            this.Property(a => a.ReferenceStatusRowID).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            this.HasRequired(a => a.PQReference).WithMany().HasForeignKey(a => a.ReferenceRowID).WillCascadeOnDelete(false);
        }
    }
}
