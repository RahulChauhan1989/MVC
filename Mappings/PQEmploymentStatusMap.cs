...
{
    public class PQEmploymentStatusMap : EntityTypeConfiguration<PQEmploymentStatus>
    {
        public PQEmploymentStatusMap()
        {
            this.HasKey(a => a.EmploymentStatusRowID);
            this.Property(a => a.EmploymentStatusRowID).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            this.HasRequired(a => a.PQEmployment).WithMany().HasForeignKey(a => a.EmploymentRowId).WillCascadeOnDelete(false);
        }
    }
}
