...
{
    class PQCriminalStatusMap : EntityTypeConfiguration<PQCriminalStatus>
    {
        public PQCriminalStatusMap()
        {
            this.HasKey(a => a.CriminalStatusRowID);
            this.Property(a => a.CriminalStatusRowID).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            this.HasRequired(a => a.PQCriminal).WithMany().HasForeignKey(a => a.CriminalRowId).WillCascadeOnDelete(false);
        }
    }
}
