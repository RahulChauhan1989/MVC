...
{
    class PQEducationStatusMap : EntityTypeConfiguration<PQEducationStatus>
    {
        public PQEducationStatusMap()
        {
            this.HasKey(a => a.EducationStatusRowID);
            this.Property(a => a.EducationStatusRowID).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            this.HasRequired(a => a.PQEducation).WithMany().HasForeignKey(a => a.EducationRowId).WillCascadeOnDelete(false);
        }
    }
}
