...
{
    public class PQAddressStatusMap : EntityTypeConfiguration<PQAddressStatus>
    {
        public PQAddressStatusMap()
        {
            this.HasKey(a => a.AddressStatusRowID);
            this.Property(a => a.AddressStatusRowID).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            this.HasRequired(a => a.PQAddress).WithMany().HasForeignKey(a => a.AddressRowID).WillCascadeOnDelete(false);
        }
    }
}
