...
{
    public class PQSpecialCheckStatusMap : EntityTypeConfiguration<PQSpecialCheckStatus>
    {
        public PQSpecialCheckStatusMap()
        {
            this.HasKey(a => a.SpecialCheckStatusRowID);
            this.Property(a => a.SpecialCheckStatusRowID).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            this.HasRequired(a => a.PQSpecialCheck).WithMany().HasForeignKey(a => a.SpecialCheckRowId).WillCascadeOnDelete(false);
        }
    }
}
